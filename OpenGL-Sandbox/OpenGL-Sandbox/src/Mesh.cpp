...
AssetLoader::Mesh::Mesh(const std::vector<Vertex>& vertices, const std::vector<unsigned int>& indices, const std::vector<Texture>& textures)
	: m_Vertices(vertices), m_Indices(indices), m_Textures(textures)
{
	SetupMesh();
}

void AssetLoader::Mesh::Draw(const Shader& shader)
{
...
void AssetLoader::Mesh::SetupMesh()
{
